...
pull back: `from-ls-cloud --group golden-eval --project-id 37 --name golden --masks` →
verified-golden = the golden per-class-AP eval set, tier=sealed-ish) ·
**36 = "farfem-v1 pseudo-seg verify (brush)"** (2186 tasks; yolo26x_1280
